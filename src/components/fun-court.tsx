...
const demoCases = [
    {
        ...
        verdict: "The AI Judge determined that while the Defendant met the letter of the contract, industry best practice suggests scaling security with ticket sales. It recommended a future contract clause linking security levels to final attendance numbers."
    },
    {
        id: 'CASE-002',
        ...
        verdict: "The AI Judge noted that while the liability waiver holds some weight, a 'secure' cloakroom implies a reasonable duty of care. The verdict suggested the Defendant should offer partial compensation as a gesture of goodwill to maintain its reputation."
    },
    {
        id: 'CASE-003',
    ...
    },
    {
        ...
        verdict: "The AI Judge ruled in favor of the Defendant. At private events with strict no-camera policies, even the appearance of using a phone can disrupt the safety and privacy of others. The verdict emphasized the importance of respecting house rules for the comfort of all guests."
    },
    {
        id: 'CASE-005',
        ...
        verdict: "The AI Judge found the Defendant's claim to be reasonable but noted the clause was vague. It recommended the venue create a clear schedule of additional fees for specific materials (like glitter, smoke machines, etc.) to ensure transparency for future hosts."
    },
    {
        id: 'CASE-006',
        ...
        verdict: "The AI Judge suggested a shared responsibility. While the Defendant showed due diligence, the issue still impacted the event. The verdict recommended a joint sound check before the next event and a small partial refund of the DJ's fee as a gesture of partnership."
    },
    {
        id: 'CASE-007',
        ...
        verdict: "The AI Judge upheld the Defendant's decision. The 'last entry' time is a clear and binding condition of the ticket. While unfortunate for the guest, enforcing such rules is critical for event management. No refund was recommended."
    },
    {
        id: 'CASE-008',
        ...
        verdict: "The AI Judge sided with the Defendant, as the contract was clear. However, it added that crediting photographers is a professional courtesy that builds good relationships and recommended the host do so in the future, even if not contractually required."
    }
];
